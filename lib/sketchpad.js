window.addEventListener('load', function () {
    ...
    this.document.getElementById('connect').addEventListener('click', async function (event) {
        event.preventDefault();
        var warpUtil = window['startWarp'];
        var contract = await warpUtil.startWarpContact();
    }, false)
    ...
    document.getElementById('sketchRecogniseButton').addEventListener('click', function (event) {
        ...
        //  ENTER WARP -- SEND BITMAP TO WARP MAINNET

        console.log(`imgData: ${imgData}`);
        var imgUtil = window["imgUtil"];
